"""
Django settings for withered_king_dev_98736 project.
...
ROOT_URLCONF = 'withered_king_dev_98736.urls'
...
WSGI_APPLICATION = 'withered_king_dev_98736.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_king_dev_98736 API",
    "DESCRIPTION": "API documentation for withered_king_dev_98736 App",
    "VERSION": "v1",
}
